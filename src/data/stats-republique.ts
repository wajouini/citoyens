...
export const statsRepublique: StatRepublique[] = [
  {
    ...
    direction: 'down',
    source: 'INSEE',
    source_url: 'https://www.insee.fr/fr/statistiques/2830164',
  },
  {
    theme: 'Déficit',
    valeur: '6.1%',
  ...
  },
  {
    ...
    direction: 'down',
    source: 'CEVIPOF',
    source_url: 'https://www.sciencespo.fr/cevipof/fr/content/le-barometre-de-la-confiance-politique.html',
  },
  {
    theme: 'Participation',
    valeur: '47%',
